...
//rolling_nav_bar: ^0.0.2
class SampleBottomNavigationBar32 extends StatefulWidget {
  @override
  _SampleBottomNavigationBar32State createState() => _SampleBottomNavigationBar32State();
}

class _SampleBottomNavigationBar32State extends State<SampleBottomNavigationBar32> {
  Color logoColor;
  int activeIndex;
