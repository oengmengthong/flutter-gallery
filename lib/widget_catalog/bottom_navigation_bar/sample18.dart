...
class SampleBottomNavigationBar18 extends StatefulWidget {
  @override
  _SampleBottomNavigationBar18State createState() => _SampleBottomNavigationBar18State();
}

class _SampleBottomNavigationBar18State extends State<SampleBottomNavigationBar18> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Sample 18'),),
      body: Stack(
        children: <Widget>[
          AnimatedSwitcher(
