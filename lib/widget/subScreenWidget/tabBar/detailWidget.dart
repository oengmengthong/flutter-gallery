...
class TabBarWidgetScreen extends StatefulWidget {
  @override
  _TabBarWidgetScreenState createState() => _TabBarWidgetScreenState();
}

class _TabBarWidgetScreenState extends State<TabBarWidgetScreen> {
  @override
