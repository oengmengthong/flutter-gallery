...
class DecoratedBoxWidgetScreen extends StatefulWidget {
  @override
  _DecoratedBoxWidgetScreenState createState() => _DecoratedBoxWidgetScreenState();
}

class _DecoratedBoxWidgetScreenState extends State<DecoratedBoxWidgetScreen> {
  @override
