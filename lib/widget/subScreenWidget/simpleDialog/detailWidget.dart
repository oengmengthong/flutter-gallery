...
class SimpleDialogWidgetScreen extends StatefulWidget {
  @override
  _SimpleDialogWidgetScreenState createState() => _SimpleDialogWidgetScreenState();
}

class _SimpleDialogWidgetScreenState extends State<SimpleDialogWidgetScreen> {
  @override
