...
class AnimatedSizeWidgetScreen extends StatefulWidget {
  @override
  _AnimatedSizeWidgetScreenState createState() => _AnimatedSizeWidgetScreenState();
}

class _AnimatedSizeWidgetScreenState extends State<AnimatedSizeWidgetScreen> {
  @override
