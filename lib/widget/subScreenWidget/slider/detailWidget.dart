...
class SlideWidgetScreen extends StatefulWidget {
  @override
  _SlideWidgetScreenState createState() => _SlideWidgetScreenState();
}

class _SlideWidgetScreenState extends State<SlideWidgetScreen> {
  @override
