...
class SliverAppBarWidgetScreen extends StatefulWidget {
  @override
  _SliverAppBarWidgetScreenState createState() => _SliverAppBarWidgetScreenState();
}

class _SliverAppBarWidgetScreenState extends State<SliverAppBarWidgetScreen> {
  @override
