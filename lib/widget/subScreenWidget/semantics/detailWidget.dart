...
class SemanticsWidgetScreen extends StatefulWidget {
  @override
  _SemanticsWidgetScreenState createState() => _SemanticsWidgetScreenState();
}

class _SemanticsWidgetScreenState extends State<SemanticsWidgetScreen> {
  @override
