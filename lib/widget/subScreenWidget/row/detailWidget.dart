...
class RowWidgetScreen extends StatefulWidget {
  @override
  _RowWidgetScreenState createState() => _RowWidgetScreenState();
}

class _RowWidgetScreenState extends State<RowWidgetScreen> {
  @override
