...
class MediaQueryWidgetScreen extends StatefulWidget {
  @override
  _MediaQueryWidgetScreenState createState() => _MediaQueryWidgetScreenState();
}

class _MediaQueryWidgetScreenState extends State<MediaQueryWidgetScreen> {
  @override
