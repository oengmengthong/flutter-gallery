...
class FittedBoxWidgetScreen extends StatefulWidget {
  @override
  _FittedBoxWidgetScreenState createState() => _FittedBoxWidgetScreenState();
}

class _FittedBoxWidgetScreenState extends State<FittedBoxWidgetScreen> {
  @override
