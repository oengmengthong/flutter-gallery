...
class GridViewWidgetScreen extends StatefulWidget {
  @override
  _GridViewWidgetScreenState createState() => _GridViewWidgetScreenState();
}

class _GridViewWidgetScreenState extends State<GridViewWidgetScreen> {
  @override
