...
class OpacityWidgetScreen extends StatefulWidget {
  @override
  _OpacityWidgetScreenState createState() => _OpacityWidgetScreenState();
}

class _OpacityWidgetScreenState extends State<OpacityWidgetScreen> {
  @override
