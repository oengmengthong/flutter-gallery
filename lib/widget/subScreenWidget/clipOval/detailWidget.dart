...
class ClipOvalWidgetScreen extends StatefulWidget {
  @override
  _ClipOvalWidgetScreenState createState() => _ClipOvalWidgetScreenState();
}

class _ClipOvalWidgetScreenState extends State<ClipOvalWidgetScreen> {
  @override
