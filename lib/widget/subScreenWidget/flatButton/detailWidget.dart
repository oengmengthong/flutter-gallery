...
class FlatButtonWidgetScreen extends StatefulWidget {
  @override
  _FlatButtonWidgetScreenState createState() => _FlatButtonWidgetScreenState();
}

class _FlatButtonWidgetScreenState extends State<FlatButtonWidgetScreen> {
  @override
