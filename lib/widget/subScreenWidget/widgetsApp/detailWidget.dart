...
class WidgetsAppWidgetScreen extends StatefulWidget {
  @override
  _WidgetsAppWidgetScreenState createState() => _WidgetsAppWidgetScreenState();
}

class _WidgetsAppWidgetScreenState extends State<WidgetsAppWidgetScreen> {
  @override
