...
class DividerWidgetScreen extends StatefulWidget {
  @override
  _DividerWidgetScreenState createState() => _DividerWidgetScreenState();
}

class _DividerWidgetScreenState extends State<DividerWidgetScreen> {
  @override
