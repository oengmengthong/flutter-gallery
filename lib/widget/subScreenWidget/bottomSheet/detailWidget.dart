...
class BottomSheetWidgetScreen extends StatefulWidget {
  @override
  _BottomSheetWidgetScreenState createState() => _BottomSheetWidgetScreenState();
}

class _BottomSheetWidgetScreenState extends State<BottomSheetWidgetScreen> {
  @override
