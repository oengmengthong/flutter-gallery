...
class AspectRatioWidgetScreen extends StatefulWidget {
  @override
  _AspectRatioWidgetScreenState createState() => _AspectRatioWidgetScreenState();
}

class _AspectRatioWidgetScreenState extends State<AspectRatioWidgetScreen> {
  @override
