...
class MaterialAppWidgetScreen extends StatefulWidget {
  @override
  _MaterialAppWidgetScreenState createState() => _MaterialAppWidgetScreenState();
}

class _MaterialAppWidgetScreenState extends State<MaterialAppWidgetScreen> {
  @override
