...
class TooltipWidgetScreen extends StatefulWidget {
  @override
  _TooltipWidgetScreenState createState() => _TooltipWidgetScreenState();
}

class _TooltipWidgetScreenState extends State<TooltipWidgetScreen> {
  @override
