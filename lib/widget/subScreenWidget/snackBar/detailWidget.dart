...
class SnackBarWidgetScreen extends StatefulWidget {
  @override
  _SnackBarWidgetScreenState createState() => _SnackBarWidgetScreenState();
}

class _SnackBarWidgetScreenState extends State<SnackBarWidgetScreen> {
  @override
