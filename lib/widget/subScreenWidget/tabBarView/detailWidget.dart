...
class TabBarViewWidgetScreen extends StatefulWidget {
  @override
  _TabBarViewWidgetScreenState createState() => _TabBarViewWidgetScreenState();
}

class _TabBarViewWidgetScreenState extends State<TabBarViewWidgetScreen> {
  @override
