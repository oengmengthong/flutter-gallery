...
class CenterWidgetScreen extends StatefulWidget {
  @override
  _CenterWidgetScreenState createState() => _CenterWidgetScreenState();
}

class _CenterWidgetScreenState extends State<CenterWidgetScreen> {
  @override
