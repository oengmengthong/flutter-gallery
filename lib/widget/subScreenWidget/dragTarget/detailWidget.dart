...
class DragTargetWidgetScreen extends StatefulWidget {
  @override
  _DragTargetWidgetScreenState createState() => _DragTargetWidgetScreenState();
}

class _DragTargetWidgetScreenState extends State<DragTargetWidgetScreen> {
  @override
