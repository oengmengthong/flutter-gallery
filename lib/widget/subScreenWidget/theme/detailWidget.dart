...
class ThemeWidgetScreen extends StatefulWidget {
  @override
  _ThemeWidgetScreenState createState() => _ThemeWidgetScreenState();
}

class _ThemeWidgetScreenState extends State<ThemeWidgetScreen> {
  @override
