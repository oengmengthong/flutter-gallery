...
class ScrollbarWidgetScreen extends StatefulWidget {
  @override
  _ScrollbarWidgetScreenState createState() => _ScrollbarWidgetScreenState();
}

class _ScrollbarWidgetScreenState extends State<ScrollbarWidgetScreen> {
  @override
