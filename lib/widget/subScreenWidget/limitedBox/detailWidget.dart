...
class LimitedBoxWidgetScreen extends StatefulWidget {
  @override
  _LimitedBoxWidgetScreenState createState() => _LimitedBoxWidgetScreenState();
}

class _LimitedBoxWidgetScreenState extends State<LimitedBoxWidgetScreen> {
  @override
