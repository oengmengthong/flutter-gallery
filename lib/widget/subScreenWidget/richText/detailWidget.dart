...
class RichTextWidgetScreen extends StatefulWidget {
  @override
  _RichTextWidgetScreenState createState() => _RichTextWidgetScreenState();
}

class _RichTextWidgetScreenState extends State<RichTextWidgetScreen> {
  @override
