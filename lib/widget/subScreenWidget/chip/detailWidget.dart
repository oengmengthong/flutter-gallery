...
class ChipWidgetScreen extends StatefulWidget {
  @override
  _ChipWidgetScreenState createState() => _ChipWidgetScreenState();
}

class _ChipWidgetScreenState extends State<ChipWidgetScreen> {
  @override
