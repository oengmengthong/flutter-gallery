...
class AssetBundleWidgetScreen extends StatefulWidget {
  @override
  _AssetBundleWidgetScreenState createState() => _AssetBundleWidgetScreenState();
}

class _AssetBundleWidgetScreenState extends State<AssetBundleWidgetScreen> {
  @override
