...
class RawImageWidgetScreen extends StatefulWidget {
  @override
  _RawImageWidgetScreenState createState() => _RawImageWidgetScreenState();
}

class _RawImageWidgetScreenState extends State<RawImageWidgetScreen> {
  @override
