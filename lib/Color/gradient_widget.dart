...
class GradientWidgetScreen extends StatefulWidget {
  @override
  _GradientWidgetScreenState createState() => _GradientWidgetScreenState();
}

class _GradientWidgetScreenState extends State<GradientWidgetScreen> {
...
List<NamedGradient> gradients = [
  ...
  NamedGradient(Gradients.coralCandyGradient, 'Coral Candy Gradient'),
  NamedGradient(Gradients.serve, 'Serve'),
];
